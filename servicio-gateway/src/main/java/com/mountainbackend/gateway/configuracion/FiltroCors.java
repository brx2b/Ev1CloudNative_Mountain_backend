...
/**
 * CORS seguro del gateway. El frontend llama SOLO a este entrypoint
 * (puerto 9000 en local); las CORS de los microservicios internos son
 * redundantes y sirven para desarrollo directo.
 */
@Component
@Order(0)
