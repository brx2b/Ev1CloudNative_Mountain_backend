...
/**
 * CORS seguro para el microservicio de pedidos.
 * La capa perimetral (AWS API Gateway) restringe el dominio del frontend;
 * este filtro permite desarrollo local y refuerza el control por origen.
 */
@Component
@Order(0)
